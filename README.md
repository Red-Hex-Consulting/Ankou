...
- All these features provide an easy way to build a custom agent under it all; once you're transport is set, take a look at the current agents and build one around your new handler with whatever TTPs you love to use.
...
- Run quickstart.py
- Note your registration key and the agent HMAC key (you can find them again later easily in your relay.config generated by quickstart)
